...
/>
 ...
 {/* right side */}
<motion.div className="w-full mdLw-1/2 bg-white/5 p-8 rounded-2xl shadow-lg border border-white/10"
initial={{opacity:0 , x:50}}
whileInView={{opacity:1 , x:0}}
transition={{duration: 0.6}}
>
...
<input type="text" name="email" placeholder="Your Email" value={formData.email} onChange={handleChange} className={`p-3 rounded-md bg-white/10 border ${errors.email ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`} />
