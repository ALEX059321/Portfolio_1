...
const roles = useMemo(() => ["mern stack developer", "full stack developer"], [])
...
>
  Hello I'm 
  <br />
  <span className="text-white font-bold text-5xl sm:text-6xl md:text-7xl lg:text-8xl lg:whitespace-nowrap">Raj Kumar</span>
</motion.h1>
<motion.p className= "mt-6 text-base sm:text-lg md:text-xl text-gray-300 max-2xl mx-auto lg:mx-0"
...
<div className="mt-10 flex gap-5 text-2xl md:text-3xl justify-center lg:justify-start">
  {socials.map(({Icon, link, lable}) => (
    <motion.a href={link}
    key = {lable} target = "_blank" aria-label={lable} rel="noopener noreferrer"
...
<div className="relative hidden lg:block ">
 ...
 />
  ...
  <motion.img src={avator} alt="Raj Kumar"
