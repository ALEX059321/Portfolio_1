  ...
  className="relative text-white"
     ...
     >
      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center">
        ...
        <div>{projects.map((project , idx) => ( <div key={project.title} className={`absolute top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-500 ${
        ...
        style={{ width : "85%" , maxWidth : "1200px" }}
            ...
            loading="lazy"
               ...
               <div className="pointer-events-none absolute insey-0"
                style={{
                  zIndex:11,
...
<div className={`absolute left-1/2 -translate-x-1/2 ${isMobile ? "bottom-20" : "bottom-10"}`}>
  <a href={activeProject?.link} target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-3 font-semibold rounded-lg bg-white text-black hover:bg-gray-200 transition-all z-30"
